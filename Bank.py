...
def image_animation():
    ...
    img=Image.open(list_imgs[index]).resize((180,74))
...
dt_lbl=Label(root,font=('Arial',20),bg='pink')
dt_lbl.pack(pady=5)
show_dt()

img=Image.open("images/logo.jpg").resize((180,74))
imgtk=ImageTk.PhotoImage(img,master=root)
...
footer_lbl=Label(root,font=('Arial',15,'bold'),fg='blue',bg='pink',text="Developed By\n Awatansh")
...
def fp_screen():
    ...
    def fp_pass():
        ...
        if torow==None:
            messagebox.showerror("Forgot Password","To ACN does not exists")
        else:
            if uemail==torow[3]:
                otp=random.randint(1000,9999)
                send_otp_4_pass(uemail,otp)
                messagebox.showinfo("Forgot Password","OTP sent to regertered email,kindly verify")
                ...
                verify_btn=Button(frm,command=verify_otp,text="Verify",fg='green',bd=5,font=('Arial',15,'bold'))
                verify_btn.place(relx=.8,rely=.6)   
                      
            else:
                messagebox.showerror("Forgot Password","Email does not match")
...
def admin_screen():
    ...
    def open():
        ...
        def openac():
            ...
            #mobile verfification
            match=re.fullmatch("[6-9][0-9]{9}",umob)
            if match==None:
                messagebox.showerror("Open Account","Kindly check format of mobile number")
                return
        ...
        name_lbl=Label(ifrm,text='Name',font=('Arial',15,'bold'))
        name_lbl.place(relx=.05,rely=.15)

        name_e=Entry(ifrm,font=('Arial',15,'bold'),bd=5)
        name_e.place(relx=.15,rely=.15)
       

        email_lbl=Label(ifrm,text='Email',font=('Arial',15,'bold'))
        email_lbl.place(relx=.05,rely=.4)

        email_e=Entry(ifrm,font=('Arial',15,'bold'),bd=5)
        email_e.place(relx=.15,rely=.4)
        

        mob_lbl=Label(ifrm,text='Mob',font=('Arial',15,'bold'))
        mob_lbl.place(relx=.05,rely=.65)

        mob_e=Entry(ifrm,font=('Arial',15,'bold'),bd=5)
        mob_e.place(relx=.15,rely=.65)
        

        adhar_lbl=Label(ifrm,text='Adhar',font=('Arial',15,'bold'))
        adhar_lbl.place(relx=.5,rely=.15)

        adhar_e=Entry(ifrm,font=('Arial',15,'bold'),bd=5)
        adhar_e.place(relx=.6,rely=.15)
        

        adr_lbl=Label(ifrm,text='Address',font=('Arial',15,'bold'))
        adr_lbl.place(relx=.5,rely=.4)

        adr_e=Entry(ifrm,font=('Arial',15,'bold'),bd=5)
        adr_e.place(relx=.6,rely=.4)

        
        dob_lbl=Label(ifrm,text='DOB',font=('Arial',15,'bold'))
        dob_lbl.place(relx=.5,rely=.65)

        dob_e=Entry(ifrm,font=('Arial',15,'bold'),bd=5)
        dob_e.place(relx=.6,rely=.65) 


        open_btn=Button(frm,command=openac,text="Open ACN",fg='green',bd=5,font=('Arial',20,'bold'))
    ...
    def close():
        ...
        def sent_close_otp():
            ...
            torow=curobj.fetchone()
            if torow==None:
                messagebox.showerror("Close Account","To ACN does not exists")
            else:
                otp=random.randint(1000,9999)
                send_otp_4_pass(torow[3],otp)
                messagebox.showinfo("Close Account","OTP sent to regertered email,kindly verify")
        ...
        otp_btn=Button(ifrm,command=sent_close_otp,width=10,text="Send OTP",bd=5,font=('Arial',15,'bold'))
        otp_btn.place(relx=.65,rely=.4)
...
def user_screen(uacn,uname):
    ...
    def check():
        ...
        t_lbl=Label(ifrm,text='This is check details screen',font=('Arial',20,'bold'),bg='white',fg='purple')
        t_lbl.pack()
    ...
    def update():
        ...
        t_lbl=Label(ifrm,text='This is update details screen',font=('Arial',20,'bold'),bg='white',fg='purple')
        t_lbl.pack()
        ...
        name_lbl=Label(ifrm,text='Name',font=('Arial',20,'bold'))
        name_lbl.place(relx=.05,rely=.15)
        ...
        email_lbl=Label(ifrm,text='Email',font=('Arial',20,'bold'))
        email_lbl.place(relx=.05,rely=.4)
        ...
        mob_lbl=Label(ifrm,text='Mob',font=('Arial',20,'bold'))
        ...
        pass_lbl=Label(ifrm,text='Pass',font=('Arial',20,'bold'))
        ...
        update_btn=Button(ifrm,command=update_details,text='update',bg='pink',bd=5,font=('Arial',20,'bold'),fg='purple')
    ...
    def deposit():
        ...
        t_lbl=Label(ifrm,text='This is deposit details screen',font=('Arial',20,'bold'),bg='white',fg='purple')
        t_lbl.pack()
        ...
        amt_lbl=Label(ifrm,text='Amount',font=('Arial',20,'bold'))
        ...
        deposit_btn=Button(ifrm,command=deposit_amt,text='deposit',bg='pink',bd=5,font=('Arial',20,'bold'),fg='purple')
    ...
    def withdraw():
        ...
        t_lbl=Label(ifrm,text='This is check withdraw screen',font=('Arial',20,'bold'),bg='white',fg='purple')
        t_lbl.pack()
        ...
        def withdraw_amt():
            ...
            if row[8]>=uamt:
                ...
                messagebox.showerror("Withdrawn","Insuffieient Balance")
        ...
        withdraw_btn=Button(ifrm,command=withdraw_amt,text='withdraw',bg='pink',bd=5,font=('Arial',20,'bold'),fg='purple')
    ...
    def transfer():
        ...
        def transfer_amt():
            ...
            torow=curobj.fetchone()
            if torow==None:
                messagebox.showerror("Transfer","To ACN does not exists")
            else:
                if row[8]>=uamt:
                    otp=random.randint(1000,9999)
                    send_otp(row[3],otp,uamt)
                    messagebox.showinfo("Transfer","OTP sent to regertered email,kindly verify")
                    ...
                    def verify_otp():
                        ...
                        if otp==uotp:
                            ...
                            conobj.commit()
                            conobj.close()
                            messagebox.showinfo("Transfer",f"{uamt} Amount WTransfered")
                            frm.destroy()
                            user_screen(uacn,None)
                        else:
                    ...
                    verify_btn=Button(ifrm,command=verify_otp,text='verify',bg='pink',bd=5,font=('Arial',15) )
                    verify_btn.place(relx=.8,rely=.6)
                else:
                    messagebox.showerror("Transfer","Insuffiencient Balance")
                    

        to_lbl=Label(ifrm,text='To ACN',font=('Arial',20,'bold'))
        ...
        transfer_btn=Button(ifrm,command=transfer_amt,text='Transfer',bg='pink',bd=5,font=('Arial',20,'bold'),fg='purple')
        transfer_btn.place(relx=.6,rely=.45)

    logout_btn=Button(frm,text='logout',bg='pink',bd=5,font=('Arial',20,'bold'),fg='purple',command=logout)
